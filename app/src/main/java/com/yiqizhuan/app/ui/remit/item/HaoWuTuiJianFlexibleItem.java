...
public class HaoWuTuiJianFlexibleItem extends AbstractFlexibleItem<HaoWuTuiJianFlexibleItem.ItemViewHolder> {
    public Context context;
    ProductListBean.Detail detail;

    public HaoWuTuiJianFlexibleItem(Context context, ProductListBean.Detail detail) {
    ...
    public int getLayoutRes() {
        return R.layout.item_haowutuijian;
    }

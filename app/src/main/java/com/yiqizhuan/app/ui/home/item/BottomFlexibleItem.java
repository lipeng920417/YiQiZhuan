 ...
 * 没有更多了
 */
public class BottomFlexibleItem extends AbstractFlexibleItem<BottomFlexibleItem.ItemViewHolder> {


    public BottomFlexibleItem(Context context) {
    }
    ...
    public int getLayoutRes() {
        return R.layout.item_user_no_more;
    }

...
public class FlowLayout extends ViewGroup {
    ...
    private static final int MAX_LINE = 100;//从0开始计数
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FlowLayout1);
        mFold = a.getBoolean(R.styleable.FlowLayout1_flow_fold_history, DEFAULT_FOLD);
        mFoldLines = a.getInt(R.styleable.FlowLayout1_flow_foldLines_history, DEFAULT_FOLD_LINES);
        mGravity = a.getInt(R.styleable.FlowLayout1_flow_gravity_history, DEFAULT_GRAVITY_LEFT);
        mEqually = a.getBoolean(R.styleable.FlowLayout1_flow_equally_history, true);
        mEquallyCount = a.getInt(R.styleable.FlowLayout1_flow_equally_count_history, 0);
        mHorizontalSpacing = a.getDimensionPixelOffset(R.styleable.FlowLayout1_flow_horizontalSpacing_history, dp2px(8));
        mVerticalSpacing = a.getDimensionPixelOffset(R.styleable.FlowLayout1_flow_verticalSpacing_history, dp2px(8));
        a.recycle();
    }
